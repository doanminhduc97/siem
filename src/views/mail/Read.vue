    ...
    <v-card-text class="pa-4">
      <div class="mail-reply--item">
        <div class="layout column">
          ...
          <div class="py-3">
            <v-alert outlined color="primary" icon="mdi-attachment" :value="true"> Weekly Report </v-alert>
          </div>
          <v-card class="pa-0" tile>
            <v-card-text>
              <v-textarea counter filled placeholder="Your reply here" full-width multi-line />
            </v-card-text>
